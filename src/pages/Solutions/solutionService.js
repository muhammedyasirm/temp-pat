const solutions = [
  {
    "id": "asset-management",
    "BannerImage": "/asset-management.jpg",
    ...
    "subheading3Description": 
      "In today’s fast-paced business environment, having comprehensive oversight of all assets is critical to maintaining smooth and efficient operations. Spire™ offers an unparalleled level of control over asset management, allowing companies to track each asset with precision and accountability. Through Spire™, businesses can implement cross-departmental cost allocation models, ensuring that each unit or department is charged accurately for the assets and resources it consumes. This granular visibility helps departments operate more transparently, making it easier to manage budgets and allocate resources effectively. The enhanced asset visibility provided by Spire™ ensures that businesses are not overextending themselves on unnecessary asset purchases or support. By consolidating infrastructure and refining asset management strategies, companies can reduce the number of assets under support contracts, ultimately decreasing maintenance costs and improving overall resource utilization. Spire™ also helps organizations meet compliance and governance requirements by maintaining detailed records of asset usage and lifecycle stages. With Spire™, businesses gain full control over their asset inventories, ensuring that every asset is accounted for, properly maintained, and optimally utilized. This ensures not only operational excellence but also significant cost savings and the ability to scale efficiently.",
    "subheading3Image": "/asset2.png",
  
    "displayImage": "assetspire-display.jpg"
  },
  {
    "id": "payment-solution",
  ...
  },
  {
    ...
    "mainTitle": "Solution 3",
    "titleDescription": "Description of Solution 3.",
    "subheading1": "Feature 1",
    "subheading1Highlighted": "Highlighted Feature 1",
    "subheading1Description": "Detailed description of Feature 1.",
    "subheading1Image": "feature1.jpg",
    "subheading2": "Feature 2",
    "subheading2Highlighted": "Highlighted Feature 2",
    "subheading2Description": "Detailed description of Feature 2.",
    "subheading2Image": "feature2.jpg",
    "subheading3": "Feature 3",
    "subheading3Highlighted": "Highlighted Feature 3",
    "subheading3Description": "Detailed description of Feature 3.",
    "subheading3Image": "feature3.jpg",
    "displayImage": "solution3-display.jpg",
  },
  {
    "id": "sites-profitability",
    "BannerImage": "/sites-profitability.jpg",
    "mainTitle": "Solution 3",
    "titleDescription": "Description of Solution 3.",
    "subheading1": "Feature 1",
    "subheading1Highlighted": "Highlighted Feature 1",
