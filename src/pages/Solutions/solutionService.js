const solutions = [
  {
    ...
    "subheading3Description": 
      "In today’s fast-paced business world, efficient asset oversight is vital. Spire™ offers unmatched control over asset management, enabling precise tracking and accountability. With cross-departmental cost allocation, businesses gain transparency, better budget management, and optimized resource use. Spire™ helps reduce unnecessary asset purchases and maintenance costs, supporting compliance with detailed records of asset usage. Achieve cost savings, enhance resource utilization, and scale effectively. Contact us to see how Spire™ can transform your asset management strategy.",
    "subheading3Image": "/Asset3.1.png",
  ...
  },
  {
    ...
    "subheading1Image": "/payment-solution2.png",
    ...
    "subheading2Image": "/payment-solution3.png",
  
    "subheading3": "Smart and Secure",
    "subheading3Highlighted": "Built-in Security and Location Mapping",
    "subheading3Description": 
      "Our mobile payment solution offers built-in location mapping, allowing you to track transactions and manage loyalty rewards effortlessly. With real-time insights and a detailed transaction record, you gain control over spending. Payments are encrypted for security, ensuring sensitive information is never stored or shared. This secure framework not only protects transactions but also keeps your financial data private. Seamlessly manage rewards, track history, and enjoy peace of mind. Contact us to see how our solution can enhance convenience and security, giving you full control over your finances.",
    "subheading3Image": "/payment-solution1.png",
  ...
  },
  {
    ...
    "subheading2Image": "/rafm2.png",
  
    "subheading3": "Flexible Deployment to Suit Your Business Needs",
    "subheading3Highlighted": "Modular and Scalable Implementation",
    "subheading3Description": 
      "The RAFM solution provides exceptional flexibility with modular delivery and deployment options, available in both Opex and Capex models to suit your financial and operational needs. It can scale to support a full transformation or specific improvements, with a quick implementation timeline of just two months. Designed to optimize workflows, manage risks, and enhance operational efficiency across all departments, RAFM enables measurable improvements in performance and profitability. Contact us to learn how RAFM can elevate your business processes and drive success.",
    "subheading3Image": "/rafm3.png",
