...
const ViewMoreSection = () => {
  return (
    <div className="bg-primary-orange text-white py-8 px-20 md-down:px-4 flex md-down:flex-col items-center md-down:items-start justify-between">
      ...
      <div className="flex-shrink-0 pr-10 md-down:pr-0 md-down:mt-5">
        <div
