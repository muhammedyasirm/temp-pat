export const serviceContent = {
  ...
  "asset-management": {
    ...
    feedBack: "Detailed information about Asset Management...",
    feedBackAuthor: "Robert Brown",
    authorCompany: "Company E",
    authorImage: "src-to-author-image",
    cubePoints: [
      {
        description: "First point to be here",
  ...
  "payment-solutions": {
    ...
    feedBack: "Detailed information about Payment Solutions...",
    feedBackAuthor: "William White",
    authorCompany: "Company F",
    authorImage: "src-to-author-image",
    cubePoints: [
      {
        description: "First point to be here",
