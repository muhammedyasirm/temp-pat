...
const InfoCard = ({ title, description, icon, showMore, onClick }) => {
  return (
    <div className="bg-[#232323] bg-opacity-[80%] text-white p-8 lg-down:p-3 rounded-md shadow-lg flex flex-col items-center justify-between text-center h-full min-h-[450px]">
      ...
      <div className="container mx-auto">
        <div className="flex flex-wrap justify-center gap-8">
          {subCategories.map((category, index) => (
            <div key={index} className="w-full lg:w-[35%] xl:w-[28%] flex justify-center px-4">
              <InfoCard
